...
function preload(){
  ...
  oppoPink2Img = loadImage("opponent3.png");
  
  oppYellow1Img = loadAnimation("opponent4.png","opponent5.png");
 oppYellow2Img = loadImage("opponent6.png");
  
  oppRed1Img = loadAnimation("opponent7.png","opponent8.png");
 oppoRed2Img = loadImage("opponent9.png");
...
function draw() {
  ...
  if (World.frameCount % 150 === 0) {
   ...
   if(pinkCG.isTouching(mainCyclist)){
    ...
    yellowCG.addImage("yellowCG", oppoYellow2Img);
    redCG.addImage("redCG",oppoRed2Img);
...
function yellowCyclists(){
        ...
        player2.addAnimation("opponentPlayer4",oppoYellow1Img);
...
function redCyclists(){
        ...
        player3.addAnimation("opponentPlayer7",oppoRed1Img);
